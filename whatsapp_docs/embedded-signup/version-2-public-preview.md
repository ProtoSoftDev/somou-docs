...
Embedded Signup is being updated with a new Phone Number First flow. You can preview it by enabling v2-public-preview. In this flow, business customers enter and verify their phone number at the start of signup, before they create or select business assets.

Functionality between v2-public-preview and v2 is identical. The key differences are the simplified UI and the Phone Number First flow.
...
This screen lets the business customer enter a new business phone number, or select an existing phone number from the dropdown, to associate with their WhatsApp Business Account. In v2-public-preview, the phone number is the first piece of information collected, before any asset selection.
