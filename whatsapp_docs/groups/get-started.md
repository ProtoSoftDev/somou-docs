...
1. Your webhook server is set up for use with Cloud API.
1. Your app is subscribed to the following groups webhook fields:
  - `group_lifecycle_update`
  - `group_participants_update`
  - `group_settings_update`
  - `group_status_update`
1. Your app is subscribed to the WhatsApp Business account of your business phone number.
1. Your app has the `whatsapp_business_messaging` permission for the business number.
