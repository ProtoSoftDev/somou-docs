...
**Warning:** This document does not include information on [messaging limits](https://developers.facebook.com/documentation/business-messaging/whatsapp/messaging-limits) based on quality rating.
...
1. Click **All tools** in the left-side menu, then click **Business Support Home**.
1. Click **Account Overview** (the speedometer icon) in the left-side menu, if necessary.

To access **Business Support Home** in Business Manager:

1. Sign into [Business Manager](https://business.facebook.com).
1. Click the **All tools** icon (three horizontal lines) at the top of the page, then click **Business Support Home**.
1. Click **Account Overview** (the speedometer icon) in the left-side menu, if necessary.
...
- Sent as a [webhook notification](#webhooks) to those subscribed.

### Enforcement actions

Accounts can become restricted or disabled depending on the number and severity of issues. Specific restrictions can be viewed in [Business Support Home](#business-support-home) along with information on next steps and requesting a review for a particular policy issue.
...
**Warning:** **Note:** Not all spam violations might be appealed. Businesses might have to wait until the restriction period ends to begin messaging again.
...
1. Choose from the list of violations and click **Request Review**.
1. A new dialog opens in Business Manager. Enter supporting details and click **Submit**.
1. After submission, the request and the issue are moved to the **In Review** tab.
1. The appeal review decision will be sent via Business Manager and typically takes 24 to 48 hours. The appealed violation will either remain **Unchanged** or be set as **Reversed**.
