...
As a Tech Provider, you can independently provide all WhatsApp messaging services to clients who you have onboarded, or you can work with a [Solution Partner](https://developers.facebook.com/documentation/business-messaging/whatsapp/solution-providers/overview#solution-partners) to jointly offer these services. If you are partnering with a Solution Partner, ask them for their app ID, which you will need to complete these steps.
...
* Billing - Your onboarded clients must [add a credit card to your WhatsApp Business Platform Account](https://www.facebook.com/business/help/488291839463771).
