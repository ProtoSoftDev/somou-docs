...
To stay up to date on the platform&#039;s performance, subscribe to the status page through the **RSS Feed** button on the WhatsApp Business API Status Page itself. See [RSS Feed](#rss-feed) for more information.
...
| --- | --- | --- |
| Green Checkmark |  | The service is up, running, and has no known issues or a recent issue has been resolved. |
| Yellow Triangle |  | The service is in recovery from disruptions or the service is experiencing some disruptions. |
| Red Stop-sign |  | The service is currently down or experiencing major disruptions. |
